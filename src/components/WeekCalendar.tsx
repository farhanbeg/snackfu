      ...
      <div className="flex-1 overflow-y-auto relative custom-scrollbar">
        <div className="flex min-h-[900px]">
          ...
          <div className="w-16 flex-shrink-0 border-r border-gray-100 bg-gray-50/50">
            {HOURS.map(hour => (
              <div key={hour} className="h-[60px] text-[10px] font-bold text-gray-400 text-right pr-2 pt-1 border-b border-gray-100/50">
                {hour}:00
              </div>
            ))}
          </div>
          ...
          <div className="flex-1 flex relative">
            ...
            <div className="absolute inset-0 pointer-events-none">
              {HOURS.map(hour => (
                <div key={hour} className="h-[60px] border-b border-gray-100/50 w-full" />
              ))}
            </div>
                    ...
                    return (
                      <motion.button
                        ...
                        className={cn(
                          ...
                          isUpcoming 
                            ? "bg-red-600 text-white border-red-700 ring-2 ring-red-500/50 ring-offset-1" 
                            : "bg-white text-gray-900 border-gray-200 hover:border-red-300 hover:shadow-md"
                        )}
                      ...
                      >
                        <div className="flex flex-col h-full justify-between">
                          <div>
                            ...
                            <p className={cn(
                              "text-[9px] mt-0.5",
                              isUpcoming ? "text-red-100" : "text-gray-500"
                            )}>
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            <span className={cn(
                              ...
                              isUpcoming ? "bg-white/20 text-white" : "bg-gray-100 text-gray-600"
                            )}>
                              {event.campus[0]}
                            </span>
                            {event.snacks.has && (
